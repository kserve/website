...
- #### [Migration job for existing KFServing installation](https://kserve.github.io/website/admin/migration)
...
<br>  
- #### (Alpha feature) Raw kubernetes deployment support, Istio/Knative dependency is now optional [Installation guide](https://kserve.github.io/website/admin/kubernetes_deployment).
