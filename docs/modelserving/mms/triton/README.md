...
KServe `Multi Model Serving` design decouples the trained model artifact from the hosting `InferenceService`. You first create a hosting `InferenceService` without `StoragegUri`
...
the issue for adding the [probing component](https://github.com/kserve/kserve/issues/1045).
