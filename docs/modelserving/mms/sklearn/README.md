...
## Example
Firstly, you should have kserve installed. Check [this](../../../get_started/README.md#4-install-kserve) out if you have not installed kserve.
...
- Go to the root directory of `kserve`
