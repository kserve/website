...
- [**Inference Gateways**](./ai-gateway/inference-gateways.md): Use Envoy AI Gateway or agentgateway with `LLMInferenceService` for inference-aware routing and gateway-specific AI policies.
