...
<td>
<em>(Optional)</em>
<p>When this field is specified KFS chooses the KServe ModelServer implementation, otherwise KFS uses the TorchServe implementation</p>
</td>
</tr>
<tr>
<td>
...
on git commit <code>d3910e0f</code>.
</em></p>
