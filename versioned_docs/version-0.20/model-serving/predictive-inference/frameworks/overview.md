...
- **[AutoGluon ModelServer](https://github.com/kserve/kserve/tree/master/python/autogluonserver)** - Specialized for AutoGluon TabularPredictor models.
...
- **[Paddle ModelServer](https://github.com/kserve/kserve/tree/master/python/paddleserver)** - Specialized for PaddlePaddle models.
...
| [Paddle ModelServer](https://github.com/kserve/kserve/tree/master/python/paddleserver)           | [Saved Model (.pdmodel)](https://www.paddlepaddle.org.cn/documentation/docs/zh/develop/guides/serving/quick_start.html)                                                                       | v1, v2 | v2          | v<ActiveDocsVersion /> (KServe)                                              | 2                                                                                                                                                          | [GitHub Examples](https://github.com/kserve/kserve/tree/master/docs/samples/v1beta1/paddle) |
...
- **\*autogluon**: Time series inference currently uses REST v1 JSON requests (`/v1/models/{name}:predict`). Tabular inference supports REST v1 and REST v2.
